...
for (const dir of [STORAGE_DIR, DATA_DIR, UPLOADS_DIR, INVOICES_DIR, CACHE_DIR, LOG_DIR]) {
  try {
    fs.mkdirSync(dir, { recursive: true, mode: 0o750 });
  } catch {}
}

module.exports = { STORAGE_DIR, DATA_DIR, UPLOADS_DIR, INVOICES_DIR, CACHE_DIR, LOG_DIR };
