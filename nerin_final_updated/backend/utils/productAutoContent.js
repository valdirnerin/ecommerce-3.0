...
function detectProductCondition(product = {}) {
  ...
  if (
    ["Original", "Compatible", "Compatible Soft OLED", "Compatible Hard OLED", "Compatible Budget", "Factory Standard", "Compatible In-Cell", "Compatible In-Cell FHD"].includes(
...
function buildH1(product, detected) {
  ...
  if (brandModel) chunks.push(`para ${brandModel}`);
